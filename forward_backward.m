function [Aopt, Bopt, piopt] = forward_backward(Ainit, Binit, piinit, nStates, nClusters, observations, classNum, nClasses, filesPerClass)
...
piopt = sum(allpi,2)./filesPerClass;
